...
const projects = [
  {
    ...
    outcome: 'A digital wallet app built from scratch that helps users track income, expenses, and recurring subscriptions with a minimalistic and intuitive mobile experience.',
